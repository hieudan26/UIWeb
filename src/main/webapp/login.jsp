			...
			<div class="row">
				<div class="col-lg-6">
					<div class="login_box_img">
						<div class="hover">													
							<img class="login_img" src="img/signin.jpg"  alt="Ảnh Banner" id="img_banner">														
				...
				<div class="col-lg-6">
					<div class="login_form_inner">
						<h3>Log in to ASLAN</h3>
						<form class="row login_form" action="#/" id="contactForm" >						
						<!--Sua lai thanh input-->
							<div class="col-md-12 form-group">
								<label class="icon_label"for="your_name"><i class="zmdi zmdi-account material-icons-name"></i></label>
								<input class="input_value" type="text" id="username" name="name" placeholder="Pls Enter Your Name" />
...
<jsp:include page="footer.jsp" />
  ...
  <script >
      ...
      Validator(// nguyên cục trong Validator là một object
        {
          form:'#contactForm',//lấy ra form cần validator
		  formGroupSelector:'.form-group',
          rules : [
            Validator.isRequired('#username'),//#username là selector
			Validator.isRequired('#password'),
			Validator.isMinlength('#password', 6,"Mật khẩu tối thiểu là 6 ký tự"),
			/*
            ...
            {
              return document.querySelector('#form-1 #password').value;//lấy ra value thanh mật khẩu
            },
